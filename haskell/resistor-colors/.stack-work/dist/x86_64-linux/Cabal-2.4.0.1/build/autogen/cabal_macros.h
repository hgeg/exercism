...
/* package resistor-colors-1.0.0.0 */
#ifndef VERSION_resistor_colors
#define VERSION_resistor_colors "1.0.0.0"
#endif /* VERSION_resistor_colors */
#ifndef MIN_VERSION_resistor_colors
#define MIN_VERSION_resistor_colors(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_resistor_colors */
...
#define CURRENT_PACKAGE_KEY "resistor-colors-1.0.0.0-FPgmZqcjZnE5BrJunannkd"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "resistor-colors-1.0.0.0-FPgmZqcjZnE5BrJunannkd"
